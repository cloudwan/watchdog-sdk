...
type RunHTTPTestRequest_ResponseFormat int32

const (
	RunHTTPTestRequest_JSON RunHTTPTestRequest_ResponseFormat = 0
	RunHTTPTestRequest_TEXT RunHTTPTestRequest_ResponseFormat = 1
)

var (
	RunHTTPTestRequest_ResponseFormat_name = map[int32]string{
		0: "JSON",
		1: "TEXT",
	}

	RunHTTPTestRequest_ResponseFormat_value = map[string]int32{
		"JSON": 0,
		"TEXT": 1,
	}
)

func (x RunHTTPTestRequest_ResponseFormat) Enum() *RunHTTPTestRequest_ResponseFormat {
	p := new(RunHTTPTestRequest_ResponseFormat)
	*p = x
	return p
}

func (x RunHTTPTestRequest_ResponseFormat) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), preflect.EnumNumber(x))
}

func (RunHTTPTestRequest_ResponseFormat) Descriptor() preflect.EnumDescriptor {
	return watchdog_proto_v1alpha2_http_test_custom_proto_enumTypes[0].Descriptor()
}

func (RunHTTPTestRequest_ResponseFormat) Type() preflect.EnumType {
	return &watchdog_proto_v1alpha2_http_test_custom_proto_enumTypes[0]
}

func (x RunHTTPTestRequest_ResponseFormat) Number() preflect.EnumNumber {
	return preflect.EnumNumber(x)
}

// Deprecated, Use RunHTTPTestRequest_ResponseFormat.ProtoReflect.Descriptor instead.
func (RunHTTPTestRequest_ResponseFormat) EnumDescriptor() ([]byte, []int) {
	return watchdog_proto_v1alpha2_http_test_custom_proto_rawDescGZIP(), []int{0, 0}
}
...
type RunHTTPTestRequest struct {
	...
	UrlFormEncodedBody   map[string]*RunHTTPTestRequest_StringArray `protobuf:"bytes,8,rep,name=url_form_encoded_body,json=urlFormEncodedBody,proto3" json:"url_form_encoded_body,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" firestore:"urlFormEncodedBody"`
	...
	ResponseFornat       RunHTTPTestRequest_ResponseFormat          `protobuf:"varint,12,opt,name=response_fornat,json=responseFornat,proto3,enum=ntt.watchdog.v1alpha2.RunHTTPTestRequest_ResponseFormat" json:"response_fornat,omitempty" firestore:"responseFornat"`
}
...
func (m *RunHTTPTestRequest) GetUrlFormEncodedBody() map[string]*RunHTTPTestRequest_StringArray {
	if m != nil {
...
func (m *RunHTTPTestRequest) GetResponseFornat() RunHTTPTestRequest_ResponseFormat {
	if m != nil {
...
func (m *RunHTTPTestRequest) SetUrlFormEncodedBody(fv map[string]*RunHTTPTestRequest_StringArray) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "UrlFormEncodedBody", "RunHTTPTestRequest"))
	}
...
func (m *RunHTTPTestRequest) SetResponseFornat(fv RunHTTPTestRequest_ResponseFormat) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "ResponseFornat", "RunHTTPTestRequest"))
	}
	m.ResponseFornat = fv
}
...
type RunHTTPTestRequest_StringArray struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (m *RunHTTPTestRequest_StringArray) Reset() {
	*m = RunHTTPTestRequest_StringArray{}
	if protoimpl.UnsafeEnabled {
...
func (m *RunHTTPTestRequest_StringArray) String() string {
	return protoimpl.X.MessageStringOf(m)
}

func (*RunHTTPTestRequest_StringArray) ProtoMessage() {}

func (m *RunHTTPTestRequest_StringArray) ProtoReflect() preflect.Message {
	mi := &watchdog_proto_v1alpha2_http_test_custom_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && m != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		if ms.LoadMessageInfo() == nil {
...
func (*RunHTTPTestRequest_StringArray) GotenMessage() {}

// Deprecated, Use RunHTTPTestRequest_StringArray.ProtoReflect.Descriptor instead.
func (*RunHTTPTestRequest_StringArray) Descriptor() ([]byte, []int) {
	return watchdog_proto_v1alpha2_http_test_custom_proto_rawDescGZIP(), []int{0, 1}
}

func (m *RunHTTPTestRequest_StringArray) Unmarshal(b []byte) error {
	return proto.Unmarshal(b, m)
}

func (m *RunHTTPTestRequest_StringArray) Marshal() ([]byte, error) {
	return proto.Marshal(m)
}

func (m *RunHTTPTestRequest_StringArray) MarshalJSON() ([]byte, error) {
	return protojson.MarshalOptions{}.Marshal(m)
}

func (m *RunHTTPTestRequest_StringArray) UnmarshalJSON(data []byte) error {
	return protojson.Unmarshal(data, m)
}

func (m *RunHTTPTestRequest_StringArray) GetValue() []string {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *RunHTTPTestRequest_StringArray) SetValue(fv []string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Value", "RunHTTPTestRequest_StringArray"))
	}
	m.Value = fv
}
...
func (m *RunHTTPTestResponse_JsonResponse) Reset() {
	*m = RunHTTPTestResponse_JsonResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &watchdog_proto_v1alpha2_http_test_custom_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (m *RunHTTPTestResponse_JsonResponse_Header) Reset() {
	*m = RunHTTPTestResponse_JsonResponse_Header{}
	if protoimpl.UnsafeEnabled {
		mi := &watchdog_proto_v1alpha2_http_test_custom_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
var watchdog_proto_v1alpha2_http_test_custom_proto_rawDesc = []byte{
	...
	0x5f, 0x72, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8c, 0x08,
	...
	,
	...
	0x01, 0x1a, 0x23, 0x0a, 0x0b, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x41, 0x72, 0x72, 0x61, 0x79,
	0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52,
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x1a, 0x7c, 0x0a, 0x17, 0x55, 0x72, 0x6c, 0x46, 0x6f, 0x72,
	...
	,
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5c, 0x0a, 0x0d, 0x6a, 0x73, 0x6f,
	...
	0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2e, 0x52, 0x75, 0x6e, 0x48, 0x54, 0x54, 0x50,
	0x54, 0x65, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x4a, 0x73, 0x6f,
	0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x0c, 0x6a, 0x73, 0x6f, 0x6e, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x1a, 0xf7, 0x01, 0x0a, 0x0c, 0x4a, 0x73, 0x6f, 0x6e,
	...
	0x0c, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x69, 0x0a,
	0x10, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x5f, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72,
	0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x3e, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x77, 0x61,
	0x74, 0x63, 0x68, 0x64, 0x6f, 0x67, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2e,
	0x52, 0x75, 0x6e, 0x48, 0x54, 0x54, 0x50, 0x54, 0x65, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x2e, 0x4a, 0x73, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x5f, 0x62, 0x6f, 0x64, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52,
	0x0c, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x6f, 0x64, 0x79, 0x1a, 0x32, 0x0a,
	...
	0x73, 0x42, 0xcb, 0x01, 0xe8, 0xde, 0x21, 0x01, 0x0a, 0x1c, 0x63, 0x6f, 0x6d, 0x2e, 0x6e, 0x74,
	0x74, 0x2e, 0x77, 0x61, 0x74, 0x63, 0x68, 0x64, 0x6f, 0x67, 0x2e, 0x70, 0x62, 0x2e, 0x76, 0x31,
	0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x42, 0x13, 0x48, 0x54, 0x54, 0x50, 0x54, 0x65, 0x73, 0x74,
	...
	0x6e, 0x74, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2f, 0x68, 0x74, 0x74, 0x70,
	0x5f, 0x74, 0x65, 0x73, 0x74, 0x3b, 0x68, 0x74, 0x74, 0x70, 0x5f, 0x74, 0x65, 0x73, 0x74, 0x5f,
...
var watchdog_proto_v1alpha2_http_test_custom_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var watchdog_proto_v1alpha2_http_test_custom_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var watchdog_proto_v1alpha2_http_test_custom_proto_goTypes = []interface{}{
	(RunHTTPTestRequest_ResponseFormat)(0),   // 0: ntt.watchdog.v1alpha2.RunHTTPTestRequest_ResponseFormat
	(*RunHTTPTestRequest)(nil),               // 1: ntt.watchdog.v1alpha2.RunHTTPTestRequest
	(*RunHTTPTestResponse)(nil),              // 2: ntt.watchdog.v1alpha2.RunHTTPTestResponse
	nil,                                      // 3: ntt.watchdog.v1alpha2.RunHTTPTestRequest.RequestHeadersEntry
	(*RunHTTPTestRequest_StringArray)(nil),   // 4: ntt.watchdog.v1alpha2.RunHTTPTestRequest.StringArray
	nil,                                      // 5: ntt.watchdog.v1alpha2.RunHTTPTestRequest.UrlFormEncodedBodyEntry
	(*RunHTTPTestResponse_JsonResponse)(nil), // 6: ntt.watchdog.v1alpha2.RunHTTPTestResponse.JsonResponse
	(*RunHTTPTestResponse_JsonResponse_Header)(nil), // 7: ntt.watchdog.v1alpha2.RunHTTPTestResponse.JsonResponse.Header
	(common.HTTPRequestMethod)(0),                   // 8: ntt.watchdog.v1alpha2.HTTPRequestMethod
	(*duration.Duration)(nil),                       // 9: google.protobuf.Duration
	(common.AuthenticationMethod)(0),                // 10: ntt.watchdog.v1alpha2.AuthenticationMethod
}
var watchdog_proto_v1alpha2_http_test_custom_proto_depIdxs = []int32{
	3,  // 0: ntt.watchdog.v1alpha2.RunHTTPTestRequest.request_headers:type_name -> ntt.watchdog.v1alpha2.RunHTTPTestRequest.RequestHeadersEntry
	8,  // 1: ntt.watchdog.v1alpha2.RunHTTPTestRequest.request_method:type_name -> ntt.watchdog.v1alpha2.HTTPRequestMethod
	9,  // 2: ntt.watchdog.v1alpha2.RunHTTPTestRequest.timeout:type_name -> google.protobuf.Duration
	10, // 3: ntt.watchdog.v1alpha2.RunHTTPTestRequest.authentication_method:type_name -> ntt.watchdog.v1alpha2.AuthenticationMethod
	5,  // 4: ntt.watchdog.v1alpha2.RunHTTPTestRequest.url_form_encoded_body:type_name -> ntt.watchdog.v1alpha2.RunHTTPTestRequest.UrlFormEncodedBodyEntry
	0,  // 5: ntt.watchdog.v1alpha2.RunHTTPTestRequest.response_fornat:type_name -> ntt.watchdog.v1alpha2.RunHTTPTestRequest_ResponseFormat
	6,  // 6: ntt.watchdog.v1alpha2.RunHTTPTestResponse.json_response:type_name -> ntt.watchdog.v1alpha2.RunHTTPTestResponse.JsonResponse
	7,  // 7: ntt.watchdog.v1alpha2.RunHTTPTestResponse.JsonResponse.response_headers:type_name -> ntt.watchdog.v1alpha2.RunHTTPTestResponse.JsonResponse.Header
	4,  // 8: ntt.watchdog.v1alpha2.RunHTTPTestRequest.UrlFormEncodedBodyEntry.value:type_name -> ntt.watchdog.v1alpha2.RunHTTPTestRequest.StringArray
...
func watchdog_proto_v1alpha2_http_test_custom_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		watchdog_proto_v1alpha2_http_test_custom_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RunHTTPTestRequest_StringArray); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		watchdog_proto_v1alpha2_http_test_custom_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		watchdog_proto_v1alpha2_http_test_custom_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         watchdog_proto_v1alpha2_http_test_custom_proto_enumTypes,
