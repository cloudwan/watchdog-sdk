...
func (c *client) ReportHops(ctx context.Context, in *ReportHopsRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/ntt.watchdog.v1alpha2.HopReportService/ReportHops", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) GetHopReports(ctx context.Context, in *GetHopReportsRequest, opts ...grpc.CallOption) (*GetHopReportsResponse, error) {
	out := new(GetHopReportsResponse)
	err := c.cc.Invoke(ctx, "/ntt.watchdog.v1alpha2.HopReportService/GetHopReports", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
