...
type ReportHopsRequest struct {
	...
	SourceIpAddress     string `protobuf:"bytes,13,opt,name=source_ip_address,json=sourceIpAddress,proto3" json:"source_ip_address,omitempty" firestore:"sourceIpAddress"`
	SourceInterfaceName string `protobuf:"bytes,14,opt,name=source_interface_name,json=sourceInterfaceName,proto3" json:"source_interface_name,omitempty" firestore:"sourceInterfaceName"`
}
...
func (m *ReportHopsRequest) SetSourceIpAddress(fv string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "SourceIpAddress", "ReportHopsRequest"))
	}
...
func (m *ReportHopsRequest) SetSourceInterfaceName(fv string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "SourceInterfaceName", "ReportHopsRequest"))
	}
...
type HopsReport struct {
	...
	IpVersion       common.IpVersion          `protobuf:"varint,4,opt,name=ip_version,json=ipVersion,proto3,enum=ntt.watchdog.v1alpha2.IpVersion" json:"ip_version,omitempty" firestore:"ipVersion"`
	// Local Interface IP Address
	SourceIpAddress     string             `protobuf:"bytes,8,opt,name=source_ip_address,json=sourceIpAddress,proto3" json:"source_ip_address,omitempty" firestore:"sourceIpAddress"`
	SourceInterfaceName string             `protobuf:"bytes,9,opt,name=source_interface_name,json=sourceInterfaceName,proto3" json:"source_interface_name,omitempty" firestore:"sourceInterfaceName"`
	Mode                common.ProbingMode `protobuf:"varint,5,opt,name=mode,proto3,enum=ntt.watchdog.v1alpha2.ProbingMode" json:"mode,omitempty" firestore:"mode"`
	TraceType           common.TraceType   `protobuf:"varint,6,opt,name=trace_type,json=traceType,proto3,enum=ntt.watchdog.v1alpha2.TraceType" json:"trace_type,omitempty" firestore:"traceType"`
...
func (m *HopsReport) SetSourceIpAddress(fv string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "SourceIpAddress", "HopsReport"))
	}
	m.SourceIpAddress = fv
}
...
func (m *HopsReport) SetSourceInterfaceName(fv string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "SourceInterfaceName", "HopsReport"))
	}
	m.SourceInterfaceName = fv
}
...
var watchdog_proto_v1alpha2_hop_report_custom_proto_rawDesc = []byte{
	...
	0x85, 0x08, 0x0a, 0x11, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x48, 0x6f, 0x70, 0x73, 0x52, 0x65,
	...
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x04, 0x74, 0x69, 0x6d, 0x65, 0x12, 0x2a, 0x0a, 0x11,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x69, 0x70, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73,
	0x73, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49,
	0x70, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x32, 0x0a, 0x15, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x5f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x66, 0x61, 0x63, 0x65, 0x5f, 0x6e, 0x61, 0x6d,
	0x65, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49,
	0x6e, 0x74, 0x65, 0x72, 0x66, 0x61, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x1a, 0x5b, 0x0a, 0x0d,
	...
	0x74, 0x22, 0xe7, 0x03, 0x0a, 0x0a, 0x48, 0x6f, 0x70, 0x73, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74,
	...
	0x6e, 0x12, 0x2a, 0x0a, 0x11, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x69, 0x70, 0x5f, 0x61,
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x73, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x49, 0x70, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x32, 0x0a,
	0x15, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x66, 0x61, 0x63,
	0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13, 0x73, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x66, 0x61, 0x63, 0x65, 0x4e, 0x61, 0x6d,
	0x65, 0x12, 0x36, 0x0a, 0x04, 0x6d, 0x6f, 0x64, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32,
