...
var watchdog_proto_v1alpha2_pcap_service_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xf5, 0x05, 0x0a, 0x0b, 0x50, 0x63, 0x61, 0x70, 0x53,
	...
	0x6d, 0x41, 0x67, 0x65, 0x6e, 0x74, 0xc8, 0xd5, 0x22, 0x00, 0x30, 0x01, 0x1a, 0x30, 0xca, 0x41,
...
var watchdog_proto_v1alpha2_pcap_service_proto_goTypes = []interface{}{
	...
	(*GetPcapResponse)(nil),             // 4: ntt.watchdog.v1alpha2.GetPcapResponse
}
var watchdog_proto_v1alpha2_pcap_service_proto_depIdxs = []int32{
	...
	3, // 3: ntt.watchdog.v1alpha2.PcapService.ReportPcap:output_type -> google.protobuf.Empty
	4, // 4: ntt.watchdog.v1alpha2.PcapService.GetPcap:output_type -> ntt.watchdog.v1alpha2.GetPcapResponse
	4, // 5: ntt.watchdog.v1alpha2.PcapService.GetPcapFileFromAgent:output_type -> ntt.watchdog.v1alpha2.GetPcapResponse
