...
// [ProbeHardwareGet][ntt.watchdog.v1alpha.ProbeHardwareGet]
...
func (m *ProbeHardwareGetRequest) Reset() {
	*m = ProbeHardwareGetRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &watchdog_proto_v1alpha_probe_hardware_custom_proto_msgTypes[0]
...
func (*ProbeHardwareGetRequest) Descriptor() ([]byte, []int) {
	return watchdog_proto_v1alpha_probe_hardware_custom_proto_rawDescGZIP(), []int{0}
}
...
type ProbeHardwareGetResponse struct {
	...
	ActivationStatus probe.Probe_Status_ActivationState_Status `protobuf:"varint,2,opt,name=activation_status,json=activationStatus,proto3,enum=ntt.watchdog.v1alpha.Probe_Status_ActivationState_Status" json:"activation_status,omitempty" firestore:"activationStatus"`
	ConnectionStatus probe.Probe_Status_ConnectionStatus       `protobuf:"varint,3,opt,name=connection_status,json=connectionStatus,proto3,enum=ntt.watchdog.v1alpha.Probe_Status_ConnectionStatus" json:"connection_status,omitempty" firestore:"connectionStatus"`
}

func (m *ProbeHardwareGetResponse) Reset() {
	*m = ProbeHardwareGetResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &watchdog_proto_v1alpha_probe_hardware_custom_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProbeHardwareGetResponse) Descriptor() ([]byte, []int) {
	return watchdog_proto_v1alpha_probe_hardware_custom_proto_rawDescGZIP(), []int{1}
}
...
// Request message for method
// [ProbeHardwareUpdate][ntt.watchdog.v1alpha.ProbeHardwareUpdate]
...
func (m *ProbeHardwareUpdateRequest) Reset() {
	*m = ProbeHardwareUpdateRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &watchdog_proto_v1alpha_probe_hardware_custom_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProbeHardwareUpdateRequest) Descriptor() ([]byte, []int) {
	return watchdog_proto_v1alpha_probe_hardware_custom_proto_rawDescGZIP(), []int{2}
}
...
func (m *ProbeHardwareUpdateResponse) Reset() {
	*m = ProbeHardwareUpdateResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &watchdog_proto_v1alpha_probe_hardware_custom_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProbeHardwareUpdateResponse) Descriptor() ([]byte, []int) {
	return watchdog_proto_v1alpha_probe_hardware_custom_proto_rawDescGZIP(), []int{3}
}
...
var watchdog_proto_v1alpha_probe_hardware_custom_proto preflect.FileDescriptor

var watchdog_proto_v1alpha_probe_hardware_custom_proto_rawDesc = []byte{
	0x0a, 0x32, 0x77, 0x61, 0x74, 0x63, 0x68, 0x64, 0x6f, 0x67, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2f, 0x70, 0x72, 0x6f, 0x62, 0x65, 0x5f, 0x68,
	0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x5f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x14, 0x6e, 0x74, 0x74, 0x2e, 0x77, 0x61, 0x74, 0x63, 0x68, 0x64,
	0x6f, 0x67, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x1a, 0x20, 0x67, 0x6f, 0x74, 0x65,
	...
	0x67, 0x6f, 0x74, 0x65, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x22, 0x67, 0x6f, 0x74,
	...
	0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x22, 0x77, 0x61, 0x74, 0x63, 0x68, 0x64, 0x6f,
	0x67, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2f,
	0x70, 0x72, 0x6f, 0x62, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8d, 0x01, 0x0a, 0x17,
	0x50, 0x72, 0x6f, 0x62, 0x65, 0x48, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x47, 0x65, 0x74,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2c, 0x0a, 0x0a, 0x70, 0x72, 0x6f, 0x62, 0x65,
	0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x0d, 0xb2, 0xda, 0x21,
	0x09, 0x0a, 0x07, 0x0a, 0x05, 0x50, 0x72, 0x6f, 0x62, 0x65, 0x52, 0x09, 0x70, 0x72, 0x6f, 0x62,
	...
	0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x3a, 0x21, 0xfa, 0xde, 0x21, 0x1d, 0x0a, 0x17,
	0x50, 0x72, 0x6f, 0x62, 0x65, 0x48, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x47, 0x65, 0x74,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x10, 0x01, 0x18, 0x02, 0x22, 0xad, 0x02, 0x0a, 0x18,
	0x50, 0x72, 0x6f, 0x62, 0x65, 0x48, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x47, 0x65, 0x74,
	...
	0x0c, 0x73, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x66, 0x0a,
	0x11, 0x61, 0x63, 0x74, 0x69, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x39, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x77,
	...
	0x69, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x2e, 0x53, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x52, 0x10, 0x61, 0x63, 0x74, 0x69, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x60, 0x0a, 0x11, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74,
	...
	,
	...
	0x6f, 0x62, 0x65, 0x5f, 0x68, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x0a, 0x1b, 0x63, 0x6f,
	0x6d, 0x2e, 0x6e, 0x74, 0x74, 0x2e, 0x77, 0x61, 0x74, 0x63, 0x68, 0x64, 0x6f, 0x67, 0x2e, 0x70,
	0x62, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x42, 0x18, 0x50, 0x72, 0x6f, 0x62, 0x65,
	0x48, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x50, 0x72,
	0x6f, 0x74, 0x6f, 0x50, 0x00, 0x5a, 0x50, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	...
	0x68, 0x61, 0x2f, 0x70, 0x72, 0x6f, 0x62, 0x65, 0x5f, 0x68, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72,
	0x65, 0x3b, 0x70, 0x72, 0x6f, 0x62, 0x65, 0x5f, 0x68, 0x61, 0x72, 0x64, 0x77, 0x61, 0x72, 0x65,
...
var (
	watchdog_proto_v1alpha_probe_hardware_custom_proto_rawDescOnce sync.Once
	watchdog_proto_v1alpha_probe_hardware_custom_proto_rawDescData = watchdog_proto_v1alpha_probe_hardware_custom_proto_rawDesc
)

func watchdog_proto_v1alpha_probe_hardware_custom_proto_rawDescGZIP() []byte {
	watchdog_proto_v1alpha_probe_hardware_custom_proto_rawDescOnce.Do(func() {
		watchdog_proto_v1alpha_probe_hardware_custom_proto_rawDescData = protoimpl.X.CompressGZIP(watchdog_proto_v1alpha_probe_hardware_custom_proto_rawDescData)
	})
	return watchdog_proto_v1alpha_probe_hardware_custom_proto_rawDescData
}

var watchdog_proto_v1alpha_probe_hardware_custom_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var watchdog_proto_v1alpha_probe_hardware_custom_proto_goTypes = []interface{}{
	(*ProbeHardwareGetRequest)(nil),                // 0: ntt.watchdog.v1alpha.ProbeHardwareGetRequest
	(*ProbeHardwareGetResponse)(nil),               // 1: ntt.watchdog.v1alpha.ProbeHardwareGetResponse
	(*ProbeHardwareUpdateRequest)(nil),             // 2: ntt.watchdog.v1alpha.ProbeHardwareUpdateRequest
	(*ProbeHardwareUpdateResponse)(nil),            // 3: ntt.watchdog.v1alpha.ProbeHardwareUpdateResponse
	(probe.Probe_Status_ActivationState_Status)(0), // 4: ntt.watchdog.v1alpha.Probe_Status_ActivationState_Status
	(probe.Probe_Status_ConnectionStatus)(0),       // 5: ntt.watchdog.v1alpha.Probe_Status_ConnectionStatus
}
var watchdog_proto_v1alpha_probe_hardware_custom_proto_depIdxs = []int32{
	4, // 0: ntt.watchdog.v1alpha.ProbeHardwareGetResponse.activation_status:type_name -> ntt.watchdog.v1alpha.Probe_Status_ActivationState_Status
	5, // 1: ntt.watchdog.v1alpha.ProbeHardwareGetResponse.connection_status:type_name -> ntt.watchdog.v1alpha.Probe_Status_ConnectionStatus
...
func init() { watchdog_proto_v1alpha_probe_hardware_custom_proto_init() }
func watchdog_proto_v1alpha_probe_hardware_custom_proto_init() {
	if watchdog_proto_v1alpha_probe_hardware_custom_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {

		watchdog_proto_v1alpha_probe_hardware_custom_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		watchdog_proto_v1alpha_probe_hardware_custom_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		watchdog_proto_v1alpha_probe_hardware_custom_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		watchdog_proto_v1alpha_probe_hardware_custom_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: watchdog_proto_v1alpha_probe_hardware_custom_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           watchdog_proto_v1alpha_probe_hardware_custom_proto_goTypes,
		DependencyIndexes: watchdog_proto_v1alpha_probe_hardware_custom_proto_depIdxs,
		MessageInfos:      watchdog_proto_v1alpha_probe_hardware_custom_proto_msgTypes,
	}.Build()
	watchdog_proto_v1alpha_probe_hardware_custom_proto = out.File
	watchdog_proto_v1alpha_probe_hardware_custom_proto_rawDesc = nil
	watchdog_proto_v1alpha_probe_hardware_custom_proto_goTypes = nil
	watchdog_proto_v1alpha_probe_hardware_custom_proto_depIdxs = nil
}
