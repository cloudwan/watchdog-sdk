...
func (c *client) GetTag(ctx context.Context, in *GetTagRequest, opts ...grpc.CallOption) (*tag.Tag, error) {
	out := new(tag.Tag)
	err := c.cc.Invoke(ctx, "/ntt.watchdog.v1alpha.TagService/GetTag", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) BatchGetTags(ctx context.Context, in *BatchGetTagsRequest, opts ...grpc.CallOption) (*BatchGetTagsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.watchdog.v1alpha.TagService/BatchGetTags", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) ListTags(ctx context.Context, in *ListTagsRequest, opts ...grpc.CallOption) (*ListTagsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.watchdog.v1alpha.TagService/ListTags", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) WatchTag(ctx context.Context, in *WatchTagRequest, opts ...grpc.CallOption) (WatchTagClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.watchdog.v1alpha.TagService/WatchTag", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) WatchTags(ctx context.Context, in *WatchTagsRequest, opts ...grpc.CallOption) (WatchTagsClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.watchdog.v1alpha.TagService/WatchTags", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) CreateTag(ctx context.Context, in *CreateTagRequest, opts ...grpc.CallOption) (*tag.Tag, error) {
	out := new(tag.Tag)
	err := c.cc.Invoke(ctx, "/ntt.watchdog.v1alpha.TagService/CreateTag", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) UpdateTag(ctx context.Context, in *UpdateTagRequest, opts ...grpc.CallOption) (*tag.Tag, error) {
	out := new(tag.Tag)
	err := c.cc.Invoke(ctx, "/ntt.watchdog.v1alpha.TagService/UpdateTag", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) DeleteTag(ctx context.Context, in *DeleteTagRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/ntt.watchdog.v1alpha.TagService/DeleteTag", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
