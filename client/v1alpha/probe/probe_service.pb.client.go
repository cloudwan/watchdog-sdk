...
func (c *client) GetProbe(ctx context.Context, in *GetProbeRequest, opts ...grpc.CallOption) (*probe.Probe, error) {
	out := new(probe.Probe)
	err := c.cc.Invoke(ctx, "/ntt.watchdog.v1alpha.ProbeService/GetProbe", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) BatchGetProbes(ctx context.Context, in *BatchGetProbesRequest, opts ...grpc.CallOption) (*BatchGetProbesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.watchdog.v1alpha.ProbeService/BatchGetProbes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) ListProbes(ctx context.Context, in *ListProbesRequest, opts ...grpc.CallOption) (*ListProbesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ntt.watchdog.v1alpha.ProbeService/ListProbes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) WatchProbe(ctx context.Context, in *WatchProbeRequest, opts ...grpc.CallOption) (WatchProbeClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.watchdog.v1alpha.ProbeService/WatchProbe", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) WatchProbes(ctx context.Context, in *WatchProbesRequest, opts ...grpc.CallOption) (WatchProbesClientStream, error) {
	stream, err := c.cc.NewStream(ctx,
		...
		"/ntt.watchdog.v1alpha.ProbeService/WatchProbes", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *client) CreateProbe(ctx context.Context, in *CreateProbeRequest, opts ...grpc.CallOption) (*probe.Probe, error) {
	out := new(probe.Probe)
	err := c.cc.Invoke(ctx, "/ntt.watchdog.v1alpha.ProbeService/CreateProbe", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) UpdateProbe(ctx context.Context, in *UpdateProbeRequest, opts ...grpc.CallOption) (*probe.Probe, error) {
	out := new(probe.Probe)
	err := c.cc.Invoke(ctx, "/ntt.watchdog.v1alpha.ProbeService/UpdateProbe", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) DeleteProbe(ctx context.Context, in *DeleteProbeRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/ntt.watchdog.v1alpha.ProbeService/DeleteProbe", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *client) ListMyProbes(ctx context.Context, in *ListProbesRequest, opts ...grpc.CallOption) (*ListProbesResponse, error) {
	out := new(ListProbesResponse)
	err := c.cc.Invoke(ctx, "/ntt.watchdog.v1alpha.ProbeService/ListMyProbes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
