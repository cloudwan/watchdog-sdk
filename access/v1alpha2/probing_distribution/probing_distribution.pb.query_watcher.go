...
func (e *QueryWatcherEvent) GetChanges() gotenresource.ResourceChangeList {
	return probing_distribution.ProbingDistributionChangeList(e.Changes)
}
...
func NewQueryWatcherWithIChan(id int, client probing_distribution_client.ProbingDistributionServiceClient,
...
func init() {
	gotenaccess.GetRegistry().RegisterQueryWatcherConstructor(probing_distribution.GetDescriptor(), func(id int, cc grpc.ClientConnInterface,
		...
		if params.Cursor != nil {
			cfg.Cursor = params.Cursor.(*probing_distribution.PagerCursor)
		}
		if params.Parent != nil {
			cfg.Parent = params.Parent.(*probing_distribution.ParentReference)
		}
		if params.Filter != nil {
			cfg.Filter = params.Filter.(*probing_distribution.Filter)
		}
		return NewQueryWatcherWithIChan(id, probing_distribution_client.NewProbingDistributionServiceClient(cc), cfg, ch)
	})
}
