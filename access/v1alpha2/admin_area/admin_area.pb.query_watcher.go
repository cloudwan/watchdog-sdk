...
func (e *QueryWatcherEvent) GetChanges() gotenresource.ResourceChangeList {
	return admin_area.AdminAreaChangeList(e.Changes)
}
...
func NewQueryWatcherWithIChan(id int, client admin_area_client.AdminAreaServiceClient,
...
func init() {
	gotenaccess.GetRegistry().RegisterQueryWatcherConstructor(admin_area.GetDescriptor(), func(id int, cc grpc.ClientConnInterface,
		...
		if params.Cursor != nil {
			cfg.Cursor = params.Cursor.(*admin_area.PagerCursor)
		}
		if params.Filter != nil {
			cfg.Filter = params.Filter.(*admin_area.Filter)
		}
		return NewQueryWatcherWithIChan(id, admin_area_client.NewAdminAreaServiceClient(cc), cfg, ch)
	})
}
