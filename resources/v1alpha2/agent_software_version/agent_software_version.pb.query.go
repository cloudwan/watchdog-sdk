...
func (q *GetQuery) SetFieldMask(mask gotenobject.FieldMask) {
	if mask != nil {
		q.Mask = mask.(*AgentSoftwareVersion_FieldMask)
	} else {
		q.Mask = nil
	}
}
...
func (qr *QueryResultSnapshot) GetResults() gotenresource.ResourceList {
	return AgentSoftwareVersionList(qr.AgentSoftwareVersions)
}
...
func (qr *QueryResultSnapshot) SetResults(results gotenresource.ResourceList) {
	if results != nil {
		qr.AgentSoftwareVersions = results.(AgentSoftwareVersionList)
	} else {
		qr.AgentSoftwareVersions = nil
	}
}
...
func (qr *QueryResultChange) GetResults() gotenresource.ResourceChangeList {
	return AgentSoftwareVersionChangeList(qr.Changes)
}
...
func (qr *QueryResultChange) SetResults(results gotenresource.ResourceChangeList) {
	if results != nil {
		qr.Changes = results.(AgentSoftwareVersionChangeList)
	} else {
		qr.Changes = nil
	}
}
