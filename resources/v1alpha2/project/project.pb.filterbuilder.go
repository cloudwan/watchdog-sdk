...
func (b *filterCndBuilder) ProbeStatusExposureMode() *filterCndBuilderProbeStatusExposureMode {
	return &filterCndBuilderProbeStatusExposureMode{builder: b.builder}
}

func (b *filterCndBuilder) SlackWebhookUrl() *filterCndBuilderSlackWebhookUrl {
	return &filterCndBuilderSlackWebhookUrl{builder: b.builder}
}

func (b *filterCndBuilder) TeamsWebhookUrl() *filterCndBuilderTeamsWebhookUrl {
	return &filterCndBuilderTeamsWebhookUrl{builder: b.builder}
}

func (b *filterCndBuilder) InternetSummaryTargetGroup() *filterCndBuilderInternetSummaryTargetGroup {
	return &filterCndBuilderInternetSummaryTargetGroup{builder: b.builder}
}

func (b *filterCndBuilder) PreferredLocale() *filterCndBuilderPreferredLocale {
	return &filterCndBuilderPreferredLocale{builder: b.builder}
}

func (b *filterCndBuilder) ExternalIpCheckUrl() *filterCndBuilderExternalIpCheckUrl {
	return &filterCndBuilderExternalIpCheckUrl{builder: b.builder}
}
...
func (b *filterCndBuilderMetadataDeleteTime) In(values []*timestamp.Timestamp) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().Metadata().DeleteTime().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMetadataDeleteTime) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().Metadata().DeleteTime().FieldPath(),
	})
}
...
func (b *filterCndBuilderMetadataDeleteTime) compare(op gotenfilter.CompareOperator, value *timestamp.Timestamp) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().Metadata().DeleteTime().WithValue(value),
	})
}
...
func (b *filterCndBuilderMetadataOwnerReferencesVersion) In(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().Metadata().OwnerReferences().Version().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMetadataOwnerReferencesVersion) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().Metadata().OwnerReferences().Version().FieldPath(),
	})
}
...
func (b *filterCndBuilderMetadataOwnerReferencesVersion) compare(op gotenfilter.CompareOperator, value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().Metadata().OwnerReferences().Version().WithValue(value),
	})
}
...
func (b *filterCndBuilderMetadataOwnerReferencesRegion) In(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().Metadata().OwnerReferences().Region().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMetadataOwnerReferencesRegion) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().Metadata().OwnerReferences().Region().FieldPath(),
	})
}
...
func (b *filterCndBuilderMetadataOwnerReferencesRegion) compare(op gotenfilter.CompareOperator, value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().Metadata().OwnerReferences().Region().WithValue(value),
	})
}
...
func (b *filterCndBuilderMetadataOwnerReferencesRequiresOwnerReference) In(values []bool) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().Metadata().OwnerReferences().RequiresOwnerReference().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMetadataOwnerReferencesRequiresOwnerReference) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().Metadata().OwnerReferences().RequiresOwnerReference().FieldPath(),
	})
}
...
func (b *filterCndBuilderMetadataOwnerReferencesRequiresOwnerReference) compare(op gotenfilter.CompareOperator, value bool) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().Metadata().OwnerReferences().RequiresOwnerReference().WithValue(value),
	})
}
...
func (b *filterCndBuilderMetadataLifecycle) In(values []*ntt_meta.Lifecycle) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().Metadata().Lifecycle().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMetadataLifecycle) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().Metadata().Lifecycle().FieldPath(),
	})
}
...
func (b *filterCndBuilderMetadataLifecycle) compare(op gotenfilter.CompareOperator, value *ntt_meta.Lifecycle) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().Metadata().Lifecycle().WithValue(value),
	})
}
...
func (b *filterCndBuilderMetadataLifecycleState) In(values []ntt_meta.Lifecycle_State) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().Metadata().Lifecycle().State().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMetadataLifecycleState) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().Metadata().Lifecycle().State().FieldPath(),
	})
}
...
func (b *filterCndBuilderMetadataLifecycleState) compare(op gotenfilter.CompareOperator, value ntt_meta.Lifecycle_State) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().Metadata().Lifecycle().State().WithValue(value),
	})
}
...
func (b *filterCndBuilderMetadataLifecycleBlockDeletion) In(values []bool) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().Metadata().Lifecycle().BlockDeletion().WithArrayOfValues(values),
	})
}
...
func (b *filterCndBuilderMetadataLifecycleBlockDeletion) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().Metadata().Lifecycle().BlockDeletion().FieldPath(),
	})
}
...
func (b *filterCndBuilderMetadataLifecycleBlockDeletion) compare(op gotenfilter.CompareOperator, value bool) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().Metadata().Lifecycle().BlockDeletion().WithValue(value),
	})
}
...
type filterCndBuilderProbeStatusExposureMode struct {
	builder *FilterBuilder
}

func (b *filterCndBuilderProbeStatusExposureMode) Eq(value Project_ProbeStatusExposureMode) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderProbeStatusExposureMode) Neq(value Project_ProbeStatusExposureMode) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderProbeStatusExposureMode) Gt(value Project_ProbeStatusExposureMode) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderProbeStatusExposureMode) Gte(value Project_ProbeStatusExposureMode) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderProbeStatusExposureMode) Lt(value Project_ProbeStatusExposureMode) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderProbeStatusExposureMode) Lte(value Project_ProbeStatusExposureMode) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderProbeStatusExposureMode) In(values []Project_ProbeStatusExposureMode) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().ProbeStatusExposureMode().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderProbeStatusExposureMode) NotIn(values []Project_ProbeStatusExposureMode) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().ProbeStatusExposureMode().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderProbeStatusExposureMode) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().ProbeStatusExposureMode().FieldPath(),
	})
}

func (b *filterCndBuilderProbeStatusExposureMode) IsNan() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNaN{
		FieldPath: NewProjectFieldPathBuilder().ProbeStatusExposureMode().FieldPath(),
	})
}

func (b *filterCndBuilderProbeStatusExposureMode) compare(op gotenfilter.CompareOperator, value Project_ProbeStatusExposureMode) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().ProbeStatusExposureMode().WithValue(value),
	})
}

type filterCndBuilderSlackWebhookUrl struct {
	builder *FilterBuilder
}

func (b *filterCndBuilderSlackWebhookUrl) Eq(value string) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderSlackWebhookUrl) Neq(value string) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderSlackWebhookUrl) Gt(value string) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderSlackWebhookUrl) Gte(value string) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderSlackWebhookUrl) Lt(value string) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderSlackWebhookUrl) Lte(value string) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderSlackWebhookUrl) In(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().SlackWebhookUrl().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderSlackWebhookUrl) NotIn(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().SlackWebhookUrl().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderSlackWebhookUrl) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().SlackWebhookUrl().FieldPath(),
	})
}

func (b *filterCndBuilderSlackWebhookUrl) IsNan() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNaN{
		FieldPath: NewProjectFieldPathBuilder().SlackWebhookUrl().FieldPath(),
	})
}

func (b *filterCndBuilderSlackWebhookUrl) compare(op gotenfilter.CompareOperator, value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().SlackWebhookUrl().WithValue(value),
	})
}

type filterCndBuilderTeamsWebhookUrl struct {
	builder *FilterBuilder
}

func (b *filterCndBuilderTeamsWebhookUrl) Eq(value string) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderTeamsWebhookUrl) Neq(value string) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderTeamsWebhookUrl) Gt(value string) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderTeamsWebhookUrl) Gte(value string) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderTeamsWebhookUrl) Lt(value string) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderTeamsWebhookUrl) Lte(value string) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderTeamsWebhookUrl) In(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().TeamsWebhookUrl().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderTeamsWebhookUrl) NotIn(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().TeamsWebhookUrl().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderTeamsWebhookUrl) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().TeamsWebhookUrl().FieldPath(),
	})
}

func (b *filterCndBuilderTeamsWebhookUrl) IsNan() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNaN{
		FieldPath: NewProjectFieldPathBuilder().TeamsWebhookUrl().FieldPath(),
	})
}

func (b *filterCndBuilderTeamsWebhookUrl) compare(op gotenfilter.CompareOperator, value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().TeamsWebhookUrl().WithValue(value),
	})
}

type filterCndBuilderInternetSummaryTargetGroup struct {
	builder *FilterBuilder
}

func (b *filterCndBuilderInternetSummaryTargetGroup) Eq(value string) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderInternetSummaryTargetGroup) Neq(value string) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderInternetSummaryTargetGroup) Gt(value string) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderInternetSummaryTargetGroup) Gte(value string) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderInternetSummaryTargetGroup) Lt(value string) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderInternetSummaryTargetGroup) Lte(value string) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderInternetSummaryTargetGroup) In(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().InternetSummaryTargetGroup().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderInternetSummaryTargetGroup) NotIn(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().InternetSummaryTargetGroup().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderInternetSummaryTargetGroup) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().InternetSummaryTargetGroup().FieldPath(),
	})
}

func (b *filterCndBuilderInternetSummaryTargetGroup) IsNan() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNaN{
		FieldPath: NewProjectFieldPathBuilder().InternetSummaryTargetGroup().FieldPath(),
	})
}

func (b *filterCndBuilderInternetSummaryTargetGroup) compare(op gotenfilter.CompareOperator, value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().InternetSummaryTargetGroup().WithValue(value),
	})
}

type filterCndBuilderPreferredLocale struct {
	builder *FilterBuilder
}

func (b *filterCndBuilderPreferredLocale) Eq(value *Project_Locale) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderPreferredLocale) Neq(value *Project_Locale) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderPreferredLocale) Gt(value *Project_Locale) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderPreferredLocale) Gte(value *Project_Locale) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderPreferredLocale) Lt(value *Project_Locale) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderPreferredLocale) Lte(value *Project_Locale) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderPreferredLocale) In(values []*Project_Locale) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().PreferredLocale().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderPreferredLocale) NotIn(values []*Project_Locale) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().PreferredLocale().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderPreferredLocale) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().PreferredLocale().FieldPath(),
	})
}

func (b *filterCndBuilderPreferredLocale) IsNan() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNaN{
		FieldPath: NewProjectFieldPathBuilder().PreferredLocale().FieldPath(),
	})
}

func (b *filterCndBuilderPreferredLocale) compare(op gotenfilter.CompareOperator, value *Project_Locale) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().PreferredLocale().WithValue(value),
	})
}

func (b *filterCndBuilderPreferredLocale) LangugageCode() *filterCndBuilderPreferredLocaleLangugageCode {
	return &filterCndBuilderPreferredLocaleLangugageCode{builder: b.builder}
}

type filterCndBuilderPreferredLocaleLangugageCode struct {
	builder *FilterBuilder
}

func (b *filterCndBuilderPreferredLocaleLangugageCode) Eq(value string) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderPreferredLocaleLangugageCode) Neq(value string) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderPreferredLocaleLangugageCode) Gt(value string) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderPreferredLocaleLangugageCode) Gte(value string) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderPreferredLocaleLangugageCode) Lt(value string) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderPreferredLocaleLangugageCode) Lte(value string) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderPreferredLocaleLangugageCode) In(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().PreferredLocale().LangugageCode().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderPreferredLocaleLangugageCode) NotIn(values []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().PreferredLocale().LangugageCode().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderPreferredLocaleLangugageCode) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().PreferredLocale().LangugageCode().FieldPath(),
	})
}

func (b *filterCndBuilderPreferredLocaleLangugageCode) IsNan() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNaN{
		FieldPath: NewProjectFieldPathBuilder().PreferredLocale().LangugageCode().FieldPath(),
	})
}

func (b *filterCndBuilderPreferredLocaleLangugageCode) compare(op gotenfilter.CompareOperator, value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
...
type filterCndBuilderExternalIpCheckUrl struct {
	builder *FilterBuilder
}

func (b *filterCndBuilderExternalIpCheckUrl) Eq(value []string) *FilterBuilder {
	return b.compare(gotenfilter.Eq, value)
}

func (b *filterCndBuilderExternalIpCheckUrl) Neq(value []string) *FilterBuilder {
	return b.compare(gotenfilter.Neq, value)
}

func (b *filterCndBuilderExternalIpCheckUrl) Gt(value []string) *FilterBuilder {
	return b.compare(gotenfilter.Gt, value)
}

func (b *filterCndBuilderExternalIpCheckUrl) Gte(value []string) *FilterBuilder {
	return b.compare(gotenfilter.Gte, value)
}

func (b *filterCndBuilderExternalIpCheckUrl) Lt(value []string) *FilterBuilder {
	return b.compare(gotenfilter.Lt, value)
}

func (b *filterCndBuilderExternalIpCheckUrl) Lte(value []string) *FilterBuilder {
	return b.compare(gotenfilter.Lte, value)
}

func (b *filterCndBuilderExternalIpCheckUrl) In(values [][]string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().ExternalIpCheckUrl().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderExternalIpCheckUrl) NotIn(values [][]string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionNotIn{
		Project_FieldPathArrayOfValues: NewProjectFieldPathBuilder().ExternalIpCheckUrl().WithArrayOfValues(values),
	})
}

func (b *filterCndBuilderExternalIpCheckUrl) IsNull() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNull{
		FieldPath: NewProjectFieldPathBuilder().ExternalIpCheckUrl().FieldPath(),
	})
}

func (b *filterCndBuilderExternalIpCheckUrl) IsNan() *FilterBuilder {
	return b.builder.addCond(&FilterConditionIsNaN{
		FieldPath: NewProjectFieldPathBuilder().ExternalIpCheckUrl().FieldPath(),
	})
}

func (b *filterCndBuilderExternalIpCheckUrl) Contains(value string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionContains{
		Type:      gotenresource.ConditionContainsTypeValue,
		FieldPath: NewProjectFieldPathBuilder().ExternalIpCheckUrl().FieldPath(),
		Value:     NewProjectFieldPathBuilder().ExternalIpCheckUrl().WithItemValue(value),
	})
}

func (b *filterCndBuilderExternalIpCheckUrl) ContainsAnyOf(values []string) *FilterBuilder {
	pathSelector := NewProjectFieldPathBuilder().ExternalIpCheckUrl()
	itemValues := make([]Project_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
	}
...
func (b *filterCndBuilderExternalIpCheckUrl) ContainsAll(values []string) *FilterBuilder {
	pathSelector := NewProjectFieldPathBuilder().ExternalIpCheckUrl()
	itemValues := make([]Project_FieldPathArrayItemValue, 0, len(values))
	for _, value := range values {
		itemValues = append(itemValues, pathSelector.WithItemValue(value))
...
func (b *filterCndBuilderExternalIpCheckUrl) compare(op gotenfilter.CompareOperator, value []string) *FilterBuilder {
	return b.builder.addCond(&FilterConditionCompare{
		Operator:               op,
		Project_FieldPathValue: NewProjectFieldPathBuilder().ExternalIpCheckUrl().WithValue(value),
	})
}
