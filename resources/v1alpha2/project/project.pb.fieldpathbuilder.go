...
func (ProjectFieldPathBuilder) ProbeStatusExposureMode() ProjectPathSelectorProbeStatusExposureMode {
	return ProjectPathSelectorProbeStatusExposureMode{}
}
func (ProjectFieldPathBuilder) SlackWebhookUrl() ProjectPathSelectorSlackWebhookUrl {
	return ProjectPathSelectorSlackWebhookUrl{}
}
func (ProjectFieldPathBuilder) TeamsWebhookUrl() ProjectPathSelectorTeamsWebhookUrl {
	return ProjectPathSelectorTeamsWebhookUrl{}
}
func (ProjectFieldPathBuilder) InternetSummaryTargetGroup() ProjectPathSelectorInternetSummaryTargetGroup {
	return ProjectPathSelectorInternetSummaryTargetGroup{}
}
...
type ProjectPathSelectorProbeStatusExposureMode struct{}

func (ProjectPathSelectorProbeStatusExposureMode) FieldPath() *Project_FieldTerminalPath {
	return &Project_FieldTerminalPath{selector: Project_FieldPathSelectorProbeStatusExposureMode}
}

func (s ProjectPathSelectorProbeStatusExposureMode) WithValue(value Project_ProbeStatusExposureMode) *Project_FieldTerminalPathValue {
	return s.FieldPath().WithIValue(value).(*Project_FieldTerminalPathValue)
}

func (s ProjectPathSelectorProbeStatusExposureMode) WithArrayOfValues(values []Project_ProbeStatusExposureMode) *Project_FieldTerminalPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*Project_FieldTerminalPathArrayOfValues)
}

type ProjectPathSelectorSlackWebhookUrl struct{}

func (ProjectPathSelectorSlackWebhookUrl) FieldPath() *Project_FieldTerminalPath {
	return &Project_FieldTerminalPath{selector: Project_FieldPathSelectorSlackWebhookUrl}
}

func (s ProjectPathSelectorSlackWebhookUrl) WithValue(value string) *Project_FieldTerminalPathValue {
	return s.FieldPath().WithIValue(value).(*Project_FieldTerminalPathValue)
}

func (s ProjectPathSelectorSlackWebhookUrl) WithArrayOfValues(values []string) *Project_FieldTerminalPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*Project_FieldTerminalPathArrayOfValues)
}

type ProjectPathSelectorTeamsWebhookUrl struct{}

func (ProjectPathSelectorTeamsWebhookUrl) FieldPath() *Project_FieldTerminalPath {
	return &Project_FieldTerminalPath{selector: Project_FieldPathSelectorTeamsWebhookUrl}
}

func (s ProjectPathSelectorTeamsWebhookUrl) WithValue(value string) *Project_FieldTerminalPathValue {
	return s.FieldPath().WithIValue(value).(*Project_FieldTerminalPathValue)
}

func (s ProjectPathSelectorTeamsWebhookUrl) WithArrayOfValues(values []string) *Project_FieldTerminalPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*Project_FieldTerminalPathArrayOfValues)
}

type ProjectPathSelectorInternetSummaryTargetGroup struct{}

func (ProjectPathSelectorInternetSummaryTargetGroup) FieldPath() *Project_FieldTerminalPath {
	return &Project_FieldTerminalPath{selector: Project_FieldPathSelectorInternetSummaryTargetGroup}
}

func (s ProjectPathSelectorInternetSummaryTargetGroup) WithValue(value string) *Project_FieldTerminalPathValue {
	return s.FieldPath().WithIValue(value).(*Project_FieldTerminalPathValue)
}

func (s ProjectPathSelectorInternetSummaryTargetGroup) WithArrayOfValues(values []string) *Project_FieldTerminalPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*Project_FieldTerminalPathArrayOfValues)
}

type ProjectPathSelectorPreferredLocale struct{}

func (ProjectPathSelectorPreferredLocale) FieldPath() *Project_FieldTerminalPath {
	return &Project_FieldTerminalPath{selector: Project_FieldPathSelectorPreferredLocale}
}

func (s ProjectPathSelectorPreferredLocale) WithValue(value *Project_Locale) *Project_FieldTerminalPathValue {
	return s.FieldPath().WithIValue(value).(*Project_FieldTerminalPathValue)
}

func (s ProjectPathSelectorPreferredLocale) WithArrayOfValues(values []*Project_Locale) *Project_FieldTerminalPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*Project_FieldTerminalPathArrayOfValues)
}

func (ProjectPathSelectorPreferredLocale) WithSubPath(subPath ProjectLocale_FieldPath) *Project_FieldSubPath {
	return &Project_FieldSubPath{selector: Project_FieldPathSelectorPreferredLocale, subPath: subPath}
}

func (s ProjectPathSelectorPreferredLocale) WithSubValue(subPathValue ProjectLocale_FieldPathValue) *Project_FieldSubPathValue {
	return &Project_FieldSubPathValue{Project_FieldPath: s.WithSubPath(subPathValue), subPathValue: subPathValue}
}

func (s ProjectPathSelectorPreferredLocale) WithSubArrayOfValues(subPathArrayOfValues ProjectLocale_FieldPathArrayOfValues) *Project_FieldSubPathArrayOfValues {
	return &Project_FieldSubPathArrayOfValues{Project_FieldPath: s.WithSubPath(subPathArrayOfValues), subPathArrayOfValues: subPathArrayOfValues}
}

func (s ProjectPathSelectorPreferredLocale) WithSubArrayItemValue(subPathArrayItemValue ProjectLocale_FieldPathArrayItemValue) *Project_FieldSubPathArrayItemValue {
	return &Project_FieldSubPathArrayItemValue{Project_FieldPath: s.WithSubPath(subPathArrayItemValue), subPathItemValue: subPathArrayItemValue}
}

func (ProjectPathSelectorPreferredLocale) LangugageCode() ProjectPathSelectorPreferredLocaleLangugageCode {
	return ProjectPathSelectorPreferredLocaleLangugageCode{}
}

type ProjectPathSelectorPreferredLocaleLangugageCode struct{}

func (ProjectPathSelectorPreferredLocaleLangugageCode) FieldPath() *Project_FieldSubPath {
	return &Project_FieldSubPath{
		selector: Project_FieldPathSelectorPreferredLocale,
		subPath:  NewProjectLocaleFieldPathBuilder().LangugageCode().FieldPath(),
	}
}

func (s ProjectPathSelectorPreferredLocaleLangugageCode) WithValue(value string) *Project_FieldSubPathValue {
	return s.FieldPath().WithIValue(value).(*Project_FieldSubPathValue)
}
...
func NewProjectLocaleFieldPathBuilder() ProjectLocaleFieldPathBuilder {
	return ProjectLocaleFieldPathBuilder{}
}
func (ProjectLocaleFieldPathBuilder) LangugageCode() Project_LocalePathSelectorLangugageCode {
	return Project_LocalePathSelectorLangugageCode{}
}

type Project_LocalePathSelectorLangugageCode struct{}

func (Project_LocalePathSelectorLangugageCode) FieldPath() *ProjectLocale_FieldTerminalPath {
	return &ProjectLocale_FieldTerminalPath{selector: ProjectLocale_FieldPathSelectorLangugageCode}
}

func (s Project_LocalePathSelectorLangugageCode) WithValue(value string) *ProjectLocale_FieldTerminalPathValue {
	return s.FieldPath().WithIValue(value).(*ProjectLocale_FieldTerminalPathValue)
}

func (s Project_LocalePathSelectorLangugageCode) WithArrayOfValues(values []string) *ProjectLocale_FieldTerminalPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*ProjectLocale_FieldTerminalPathArrayOfValues)
}
