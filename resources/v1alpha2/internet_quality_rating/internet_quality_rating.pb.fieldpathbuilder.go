...
func (s InternetQualityRatingPathSelectorMetadataSyncing) WithValue(value *syncing_meta.SyncingMeta) *InternetQualityRating_FieldSubPathValue {
	return s.FieldPath().WithIValue(value).(*InternetQualityRating_FieldSubPathValue)
}

func (s InternetQualityRatingPathSelectorMetadataSyncing) WithArrayOfValues(values []*syncing_meta.SyncingMeta) *InternetQualityRating_FieldSubPathArrayOfValues {
	return s.FieldPath().WithIArrayOfValues(values).(*InternetQualityRating_FieldSubPathArrayOfValues)
}
