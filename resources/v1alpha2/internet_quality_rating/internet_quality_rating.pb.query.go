...
type GetQuery struct {
	Reference *Reference
	Mask      *InternetQualityRating_FieldMask
}
...
func (q *GetQuery) SetFieldMask(mask gotenobject.FieldMask) {
	if mask != nil {
		q.Mask = mask.(*InternetQualityRating_FieldMask)
	} else {
		q.Mask = nil
	}
}
...
type QueryResultSnapshot struct {
	InternetQualityRatings []*InternetQualityRating
...
func (qr *QueryResultSnapshot) GetResults() gotenresource.ResourceList {
	return InternetQualityRatingList(qr.InternetQualityRatings)
}
...
func (qr *QueryResultSnapshot) SetResults(results gotenresource.ResourceList) {
	if results != nil {
		qr.InternetQualityRatings = results.(InternetQualityRatingList)
	} else {
		qr.InternetQualityRatings = nil
	}
}
...
type QueryResultChange struct {
	Changes        []*InternetQualityRatingChange
	PrevPageCursor *PagerCursor
	NextPageCursor *PagerCursor
	ResumeToken    string
	IsCurrent      bool
...
func (qr *QueryResultChange) GetResults() gotenresource.ResourceChangeList {
	return InternetQualityRatingChangeList(qr.Changes)
}
...
func (qr *QueryResultChange) SetResults(results gotenresource.ResourceChangeList) {
	if results != nil {
		qr.Changes = results.(InternetQualityRatingChangeList)
	} else {
		qr.Changes = nil
	}
}
