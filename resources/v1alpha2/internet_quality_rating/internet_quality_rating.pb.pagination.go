...
func (orderByFld *OrderByField) CompareWithDirection(left, right *InternetQualityRating) int {
...
func (orderBy *OrderBy) Sort(results InternetQualityRatingList) {
	if orderBy == nil {
		return
	}
...
func (orderBy *OrderBy) SortRaw(results gotenresource.ResourceList) {
	orderBy.Sort(results.(InternetQualityRatingList))
}

func (orderBy *OrderBy) InsertSorted(sorted InternetQualityRatingList, elem *InternetQualityRating) (InternetQualityRatingList, int) {
	if orderBy == nil {
...
func (orderBy *OrderBy) InsertSortedRaw(sorted gotenresource.ResourceList, elem gotenresource.Resource) (gotenresource.ResourceList, int) {
	return orderBy.InsertSorted(sorted.(InternetQualityRatingList), elem.(*InternetQualityRating))
}

func (orderBy *OrderBy) Compare(left, right *InternetQualityRating) int {
	if orderBy == nil {
		return 0
	}
	for _, fld := range orderBy.OrderByFields {
...
func (orderBy *OrderBy) CompareRaw(left, right gotenresource.Resource) int {
	return orderBy.Compare(left.(*InternetQualityRating), right.(*InternetQualityRating))
}
...
func (orderBy *OrderBy) parseOrderByField(orderByStr string) (OrderByField, error) {
	...
	// parse field path
	fp, err := ParseInternetQualityRating_FieldPath(split[0])
	if err != nil {
		return OrderByField{}, err
	}
...
func (orderBy *OrderBy) GetFieldMask() *InternetQualityRating_FieldMask {
	fieldMask := &InternetQualityRating_FieldMask{}
	if orderBy == nil {
		return fieldMask
	}
	for _, orderByField := range orderBy.OrderByFields {
...
func MakePagerQuery(orderBy *OrderBy, cursor *PagerCursor, pageSize int32, peekForward bool) *PagerQuery {
	...
	hasName := false
	for _, orderByField := range orderBy.OrderByFields {
		if orderByField.FieldPath.Selector() == InternetQualityRating_FieldPathSelectorName {
			hasName = true
		}
	}
	if !hasName {
		...
		orderBy.OrderByFields = append(orderBy.OrderByFields, OrderByField{
			FieldPath: &InternetQualityRating_FieldTerminalPath{selector: InternetQualityRating_FieldPathSelectorName},
