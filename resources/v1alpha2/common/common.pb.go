...
const (
	IpVersion_IPVERSION_ANY IpVersion = 0
...
const (
	TraceReason_UNDEFINED             TraceReason = 0
	TraceReason_USER_REQUEST_ONDEMAND TraceReason = 1
	TraceReason_PROBING_SESSION_START TraceReason = 2
	TraceReason_SLA_CHANGE            TraceReason = 3
	TraceReason_PERIODIC              TraceReason = 4
)

var (
	TraceReason_name = map[int32]string{
		0: "UNDEFINED",
		1: "USER_REQUEST_ONDEMAND",
		2: "PROBING_SESSION_START",
		3: "SLA_CHANGE",
		4: "PERIODIC",
	}
...
const (
	TraceType_UNDEFINED_TYPE TraceType = 0
	TraceType_INBAND         TraceType = 1
	TraceType_OUT_OF_BAND    TraceType = 2
)
...
func (TraceType) Descriptor() preflect.EnumDescriptor {
	return watchdog_proto_v1alpha2_common_proto_enumTypes[9].Descriptor()
}

func (TraceType) Type() preflect.EnumType {
	return &watchdog_proto_v1alpha2_common_proto_enumTypes[9]
}
...
const (
	...
	OnDemandTestResponseFormat_BOTH_TEXT_AND_JSON OnDemandTestResponseFormat = 2
)
...
type ProbingSettings struct {
	...
	// Speedtest settings
	SpeedtestSettings *SpeedTestSettings `protobuf:"bytes,5,opt,name=speedtest_settings,json=speedtestSettings,proto3" json:"speedtest_settings,omitempty" firestore:"speedtestSettings"`
...
func (m *ProbingSettings) SetSpeedtestSettings(fv *SpeedTestSettings) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "SpeedtestSettings", "ProbingSettings"))
	}
...
func (m *SpeedTestSettings) SetTcpPort(fv int32) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "TcpPort", "SpeedTestSettings"))
	}
	m.TcpPort = fv
}
...
type DNSQuery struct {
	...
	Qtype DNSResourceRecordType `protobuf:"varint,2,opt,name=qtype,proto3,enum=ntt.watchdog.v1alpha2.DNSResourceRecordType" json:"qtype,omitempty" firestore:"qtype"`
	// DNS class to query
...
func (*DNSQuery) Descriptor() ([]byte, []int) {
	return watchdog_proto_v1alpha2_common_proto_rawDescGZIP(), []int{14}
}
...
func (m *DNSQuery) SetName(fv string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Name", "DNSQuery"))
	}
	m.Name = fv
}
...
func (m *DNSQuery) SetQtype(fv DNSResourceRecordType) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Qtype", "DNSQuery"))
	}
	m.Qtype = fv
}
...
func (m *DNSQuery) SetQclass(fv DNSClass) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Qclass", "DNSQuery"))
	}
	m.Qclass = fv
}
...
type DNSResourceRecord struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty" firestore:"name"`
	// Record type
	Rrtype DNSResourceRecordType `protobuf:"varint,2,opt,name=rrtype,proto3,enum=ntt.watchdog.v1alpha2.DNSResourceRecordType" json:"rrtype,omitempty" firestore:"rrtype"`
...
func (*DNSResourceRecord) Descriptor() ([]byte, []int) {
	return watchdog_proto_v1alpha2_common_proto_rawDescGZIP(), []int{15}
}
...
func (m *DNSResourceRecord) SetName(fv string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Name", "DNSResourceRecord"))
	}
	m.Name = fv
}
...
func (m *DNSResourceRecord) SetRrtype(fv DNSResourceRecordType) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Rrtype", "DNSResourceRecord"))
	}
	m.Rrtype = fv
}
...
func (m *DNSResourceRecord) SetClass(fv DNSClass) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Class", "DNSResourceRecord"))
	}
	m.Class = fv
}
...
func (m *DNSResourceRecord) SetTtl(fv uint32) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Ttl", "DNSResourceRecord"))
	}
	m.Ttl = fv
}
...
func (m *DNSResourceRecord) SetRdlength(fv uint32) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Rdlength", "DNSResourceRecord"))
	}
	m.Rdlength = fv
}
...
func (m *DNSResourceRecord) SetRdata(fv []string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Rdata", "DNSResourceRecord"))
	}
	m.Rdata = fv
}
...
type HopInfo struct {
	...
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	HopIp         string `protobuf:"bytes,1,opt,name=hop_ip,json=hopIp,proto3" json:"hop_ip,omitempty" firestore:"hopIp"`
	HopAsn        string `protobuf:"bytes,2,opt,name=hop_asn,json=hopAsn,proto3" json:"hop_asn,omitempty" firestore:"hopAsn"`
	HopAsName     string `protobuf:"bytes,3,opt,name=hop_as_name,json=hopAsName,proto3" json:"hop_as_name,omitempty" firestore:"hopAsName"`
}
...
func (*HopInfo) Descriptor() ([]byte, []int) {
	return watchdog_proto_v1alpha2_common_proto_rawDescGZIP(), []int{16}
}
...
func (m *HopInfo) SetHopIp(fv string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "HopIp", "HopInfo"))
	}
	m.HopIp = fv
}
...
func (m *HopInfo) SetHopAsn(fv string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "HopAsn", "HopInfo"))
	}
	m.HopAsn = fv
}
...
func (m *HopInfo) SetHopAsName(fv string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "HopAsName", "HopInfo"))
	}
	m.HopAsName = fv
}
...
type HopStat struct {
	...
	sizeCache          protoimpl.SizeCache
	unknownFields      protoimpl.UnknownFields
	TtlExceededLatency *DurationStatsMilliSeconds `protobuf:"bytes,1,opt,name=ttl_exceeded_latency,json=ttlExceededLatency,proto3" json:"ttl_exceeded_latency,omitempty" firestore:"ttlExceededLatency"`
	IcmpLatency        *DurationStatsMilliSeconds `protobuf:"bytes,2,opt,name=icmp_latency,json=icmpLatency,proto3" json:"icmp_latency,omitempty" firestore:"icmpLatency"`
	Loss               *LossStats                 `protobuf:"bytes,3,opt,name=loss,proto3" json:"loss,omitempty" firestore:"loss"`
}
...
func (*HopStat) Descriptor() ([]byte, []int) {
	return watchdog_proto_v1alpha2_common_proto_rawDescGZIP(), []int{17}
}
...
func (m *HopStat) SetTtlExceededLatency(fv *DurationStatsMilliSeconds) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "TtlExceededLatency", "HopStat"))
	}
	m.TtlExceededLatency = fv
}

func (m *HopStat) SetIcmpLatency(fv *DurationStatsMilliSeconds) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "IcmpLatency", "HopStat"))
	}
	m.IcmpLatency = fv
}
...
func (m *HopStat) SetLoss(fv *LossStats) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Loss", "HopStat"))
	}
	m.Loss = fv
}

type DurationStatsMilliSeconds struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	Mean          float64 `protobuf:"fixed64,1,opt,name=mean,proto3" json:"mean,omitempty" firestore:"mean"`
	Min           float64 `protobuf:"fixed64,2,opt,name=min,proto3" json:"min,omitempty" firestore:"min"`
	Max           float64 `protobuf:"fixed64,3,opt,name=max,proto3" json:"max,omitempty" firestore:"max"`
...
func (m *DurationStatsMilliSeconds) Reset() {
	*m = DurationStatsMilliSeconds{}
	if protoimpl.UnsafeEnabled {
		mi := &watchdog_proto_v1alpha2_common_proto_msgTypes[18]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DurationStatsMilliSeconds) Descriptor() ([]byte, []int) {
	return watchdog_proto_v1alpha2_common_proto_rawDescGZIP(), []int{18}
}
...
func (m *DurationStatsMilliSeconds) SetMean(fv float64) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Mean", "DurationStatsMilliSeconds"))
	}
	m.Mean = fv
}
...
func (m *DurationStatsMilliSeconds) SetMin(fv float64) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Min", "DurationStatsMilliSeconds"))
	}
	m.Min = fv
}
...
func (m *DurationStatsMilliSeconds) SetMax(fv float64) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Max", "DurationStatsMilliSeconds"))
	}
	m.Max = fv
}
...
func (m *DurationStatsMilliSeconds) SetCount(fv int32) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Count", "DurationStatsMilliSeconds"))
	}
	m.Count = fv
}
...
type LossStats struct {
	...
	sizeCache      protoimpl.SizeCache
	unknownFields  protoimpl.UnknownFields
	PacketsSent    int32   `protobuf:"varint,1,opt,name=packets_sent,json=packetsSent,proto3" json:"packets_sent,omitempty" firestore:"packetsSent"`
	PacketsLost    int32   `protobuf:"varint,2,opt,name=packets_lost,json=packetsLost,proto3" json:"packets_lost,omitempty" firestore:"packetsLost"`
	LossPercentage float64 `protobuf:"fixed64,3,opt,name=loss_percentage,json=lossPercentage,proto3" json:"loss_percentage,omitempty" firestore:"lossPercentage"`
}
...
func (*LossStats) Descriptor() ([]byte, []int) {
	return watchdog_proto_v1alpha2_common_proto_rawDescGZIP(), []int{19}
}
...
func (m *LossStats) SetPacketsSent(fv int32) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "PacketsSent", "LossStats"))
	}
	m.PacketsSent = fv
}
...
func (m *LossStats) SetPacketsLost(fv int32) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "PacketsLost", "LossStats"))
	}
	m.PacketsLost = fv
}
...
func (m *LossStats) SetLossPercentage(fv float64) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "LossPercentage", "LossStats"))
	}
	m.LossPercentage = fv
}
...
type Path struct {
	...
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	Hops          []string `protobuf:"bytes,2,rep,name=hops,proto3" json:"hops,omitempty" firestore:"hops"`
}

func (m *Path) Reset() {
	*m = Path{}
	if protoimpl.UnsafeEnabled {
		mi := &watchdog_proto_v1alpha2_common_proto_msgTypes[20]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Path) Descriptor() ([]byte, []int) {
	return watchdog_proto_v1alpha2_common_proto_rawDescGZIP(), []int{20}
}
...
func (m *Path) SetHops(fv []string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Hops", "Path"))
	}
	m.Hops = fv
}
...
func (m *TimeInterval) Reset() {
	*m = TimeInterval{}
	if protoimpl.UnsafeEnabled {
		mi := &watchdog_proto_v1alpha2_common_proto_msgTypes[21]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TimeInterval) Descriptor() ([]byte, []int) {
	return watchdog_proto_v1alpha2_common_proto_rawDescGZIP(), []int{21}
}
...
func (m *ContactInformation_PhoneNumber) Reset() {
	*m = ContactInformation_PhoneNumber{}
	if protoimpl.UnsafeEnabled {
		mi := &watchdog_proto_v1alpha2_common_proto_msgTypes[22]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (m *ProbingConstraint_AdminHierachy) Reset() {
	*m = ProbingConstraint_AdminHierachy{}
	if protoimpl.UnsafeEnabled {
		mi := &watchdog_proto_v1alpha2_common_proto_msgTypes[23]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (m *HTTPProbingConfig_HTTPRequest) Reset() {
	*m = HTTPProbingConfig_HTTPRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &watchdog_proto_v1alpha2_common_proto_msgTypes[24]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
func (m *HTTPProbingConfig_HTTPAuth) Reset() {
	*m = HTTPProbingConfig_HTTPAuth{}
	if protoimpl.UnsafeEnabled {
		mi := &watchdog_proto_v1alpha2_common_proto_msgTypes[25]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}
...
var watchdog_proto_v1alpha2_common_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x28, 0x77, 0x61, 0x74, 0x63, 0x68, 0x64, 0x6f, 0x67, 0x2f,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2f, 0x61,
	0x64, 0x6d, 0x69, 0x6e, 0x5f, 0x61, 0x72, 0x65, 0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22,
	0x67, 0x0a, 0x0f, 0x53, 0x6f, 0x66, 0x74, 0x77, 0x61, 0x72, 0x65, 0x56, 0x65, 0x72, 0x73, 0x69,
	...
	0x08, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x62, 0x75, 0x69,
	0x6c, 0x64, 0x5f, 0x64, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x62,
	0x75, 0x69, 0x6c, 0x64, 0x44, 0x61, 0x74, 0x65, 0x22, 0xd0, 0x02, 0x0a, 0x12, 0x43, 0x6f, 0x6e,
	...
	,
	...
	,
	...
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x72, 0x79, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x63,
	0x6f, 0x6e, 0x74, 0x69, 0x6e, 0x65, 0x6e, 0x74, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09,
	...
	,
	...
	0x61, 0x63, 0x63, 0x75, 0x72, 0x61, 0x63, 0x79, 0x22, 0x79, 0x0a, 0x06, 0x41, 0x53, 0x49, 0x6e,
	0x66, 0x6f, 0x12, 0x10, 0x0a, 0x03, 0x61, 0x73, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x03, 0x61, 0x73, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01,
	...
	,
	...
	0x0c, 0x4f, 0x4e, 0x4c, 0x59, 0x5f, 0x50, 0x52, 0x49, 0x4d, 0x41, 0x52, 0x59, 0x10, 0x01, 0x12,
	0x12, 0x0a, 0x0e, 0x50, 0x52, 0x45, 0x46, 0x45, 0x52, 0x5f, 0x50, 0x52, 0x49, 0x4d, 0x41, 0x52,
	0x59, 0x10, 0x02, 0x12, 0x15, 0x0a, 0x11, 0x50, 0x52, 0x45, 0x46, 0x45, 0x52, 0x5f, 0x44, 0x49,
	0x53, 0x43, 0x4f, 0x56, 0x45, 0x52, 0x45, 0x44, 0x10, 0x03, 0x4a, 0x04, 0x08, 0x01, 0x10, 0x02,
	0x22, 0xf3, 0x02, 0x0a, 0x11, 0x50, 0x72, 0x6f, 0x62, 0x69, 0x6e, 0x67, 0x43, 0x6f, 0x6e, 0x73,
	0x74, 0x72, 0x61, 0x69, 0x6e, 0x74, 0x12, 0x7c, 0x0a, 0x1f, 0x6d, 0x61, 0x78, 0x5f, 0x73, 0x65,
	...
	,
	...
	,
	...
	,
	...
	0x52, 0x06, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x6c, 0x22, 0xab, 0x02, 0x0a, 0x11, 0x53, 0x70, 0x65,
	0x65, 0x64, 0x54, 0x65, 0x73, 0x74, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x12, 0x49,
	0x0a, 0x08, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x19, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62,
	0x75, 0x66, 0x2e, 0x44, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x12, 0xca, 0xc6, 0x27,
	0x04, 0x5a, 0x02, 0x32, 0x00, 0xca, 0xc6, 0x27, 0x06, 0x5a, 0x04, 0x22, 0x02, 0x08, 0x0a, 0x52,
	0x08, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x63, 0x0a, 0x10, 0x73, 0x65, 0x72,
	...
	,
	...
	,
	...
	,
	...
	0x06, 0x44, 0x45, 0x4c, 0x45, 0x54, 0x45, 0x10, 0x03, 0x2a, 0x4a, 0x0a, 0x14, 0x41, 0x75, 0x74,
	...
	,
	...
	0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x3b, 0x63,
...
var watchdog_proto_v1alpha2_common_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var watchdog_proto_v1alpha2_common_proto_goTypes = []interface{}{
	...
	(DNSClass)(0),                           // 6: ntt.watchdog.v1alpha2.DNSClass
	...
	(*admin_area.AdminHierarchy)(nil),       // 41: ntt.watchdog.v1alpha2.AdminHierarchy
...
var watchdog_proto_v1alpha2_common_proto_depIdxs = []int32{
	...
	41, // 2: ntt.watchdog.v1alpha2.Location.admin_hierarchy:type_name -> ntt.watchdog.v1alpha2.AdminHierarchy
	42, // 3: ntt.watchdog.v1alpha2.Location.coordinates:type_name -> google.type.LatLng
	...
	43, // 7: ntt.watchdog.v1alpha2.PathProbe.interval:type_name -> google.protobuf.Duration
	44, // 8: ntt.watchdog.v1alpha2.PathProbe.attempts:type_name -> google.protobuf.UInt32Value
	44, // 9: ntt.watchdog.v1alpha2.PathProbe.max_ttl:type_name -> google.protobuf.UInt32Value
	43, // 10: ntt.watchdog.v1alpha2.ProbingSettings.interval:type_name -> google.protobuf.Duration
	44, // 11: ntt.watchdog.v1alpha2.ProbingSettings.tos:type_name -> google.protobuf.UInt32Value
	44, // 12: ntt.watchdog.v1alpha2.ProbingSettings.window_size:type_name -> google.protobuf.UInt32Value
	...
	43, // 18: ntt.watchdog.v1alpha2.SpeedTestSettings.duration:type_name -> google.protobuf.Duration
	...
	45, // 29: ntt.watchdog.v1alpha2.TimeInterval.end_time:type_name -> google.protobuf.Timestamp
	45, // 30: ntt.watchdog.v1alpha2.TimeInterval.start_time:type_name -> google.protobuf.Timestamp
	...
	43, // 34: ntt.watchdog.v1alpha2.HTTPProbingConfig.HTTPRequest.timeout:type_name -> google.protobuf.Duration
	...
	38, // 36: ntt.watchdog.v1alpha2.HTTPProbingConfig.HTTPAuth.token_request:type_name -> ntt.watchdog.v1alpha2.HTTPProbingConfig.HTTPRequest
...
func watchdog_proto_v1alpha2_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		watchdog_proto_v1alpha2_common_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DurationStatsMilliSeconds); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		watchdog_proto_v1alpha2_common_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Path); i {
			case 0:
				return &v.state
			case 1:
		...
		watchdog_proto_v1alpha2_common_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
		...
		watchdog_proto_v1alpha2_common_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
		...
		watchdog_proto_v1alpha2_common_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
		...
		watchdog_proto_v1alpha2_common_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
		...
		watchdog_proto_v1alpha2_common_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
