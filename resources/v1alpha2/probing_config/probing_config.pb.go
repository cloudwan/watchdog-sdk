...
func (m *ProbingSession) GetSpeedtestSettings() *common.SpeedTestSettings {
	if m != nil {
...
func (m *ProbingSession) GetAddresses() []string {
	if m != nil {
		return m.Addresses
	}
	return nil
...
func (m *ProbingSession) SetSpeedtestSettings(fv *common.SpeedTestSettings) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "SpeedtestSettings", "ProbingSession"))
	}
...
func (m *ProbingSession) SetAddresses(fv []string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "Addresses", "ProbingSession"))
	}
	m.Addresses = fv
}
...
var watchdog_proto_v1alpha2_probing_config_proto_rawDesc = []byte{
	...
	0x02, 0x08, 0x02, 0x22, 0x91, 0x08, 0x0a, 0x0e, 0x50, 0x72, 0x6f, 0x62, 0x69, 0x6e, 0x67, 0x53,
	...
	0x64, 0x72, 0x65, 0x73, 0x73, 0x65, 0x73, 0x42, 0xdf, 0x03, 0xe8, 0xde, 0x21, 0x01, 0xd2, 0xff,
...
var watchdog_proto_v1alpha2_probing_config_proto_depIdxs = []int32{
	...
	13, // 9: ntt.watchdog.v1alpha2.ProbingSession.speedtest_settings:type_name -> ntt.watchdog.v1alpha2.SpeedTestSettings
