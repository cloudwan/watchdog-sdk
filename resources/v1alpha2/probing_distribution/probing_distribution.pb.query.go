...
func (q *GetQuery) SetFieldMask(mask gotenobject.FieldMask) {
	if mask != nil {
		q.Mask = mask.(*ProbingDistribution_FieldMask)
	} else {
		q.Mask = nil
	}
}
...
func (q *SearchQuery) String() string {
	return gotenresource.MakeSQLString(q.Mask, q.Filter, q.Pager, q.Phrase)
}
...
func (qr *QueryResultSnapshot) GetResults() gotenresource.ResourceList {
	return ProbingDistributionList(qr.ProbingDistributions)
}
...
func (qr *QueryResultSnapshot) SetResults(results gotenresource.ResourceList) {
	if results != nil {
		qr.ProbingDistributions = results.(ProbingDistributionList)
	} else {
		qr.ProbingDistributions = nil
	}
}
...
func (qr *QueryResultChange) GetResults() gotenresource.ResourceChangeList {
	return ProbingDistributionChangeList(qr.Changes)
}
...
func (qr *QueryResultChange) SetResults(results gotenresource.ResourceChangeList) {
	if results != nil {
		qr.Changes = results.(ProbingDistributionChangeList)
	} else {
		qr.Changes = nil
	}
}
