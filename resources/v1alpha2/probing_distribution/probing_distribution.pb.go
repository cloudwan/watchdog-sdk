...
func (m *ProbingDistribution_Spec) SetEnablePcap(fv bool) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "EnablePcap", "ProbingDistribution_Spec"))
	}
	m.EnablePcap = fv
}
...
type ProbingDistribution_Status struct {
	...
	TotalSkippedSessionCount int64 `protobuf:"varint,4,opt,name=total_skipped_session_count,json=totalSkippedSessionCount,proto3" json:"total_skipped_session_count,omitempty" firestore:"totalSkippedSessionCount"`
	// Statistics and errors by region.
	ByRegion map[string]*ProbingDistribution_Status_Regional `protobuf:"bytes,5,rep,name=by_region,json=byRegion,proto3" json:"by_region,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" firestore:"byRegion"`
}
...
func (m *ProbingDistribution_Status) GetTotalSkippedSessionCount() int64 {
	if m != nil {
		return m.TotalSkippedSessionCount
	}
	return int64(0)
}

func (m *ProbingDistribution_Status) GetByRegion() map[string]*ProbingDistribution_Status_Regional {
	if m != nil {
		return m.ByRegion
	}
	return nil
...
func (m *ProbingDistribution_Status) SetTotalSkippedSessionCount(fv int64) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "TotalSkippedSessionCount", "ProbingDistribution_Status"))
	}
	m.TotalSkippedSessionCount = fv
}

func (m *ProbingDistribution_Status) SetByRegion(fv map[string]*ProbingDistribution_Status_Regional) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "ByRegion", "ProbingDistribution_Status"))
	}
	m.ByRegion = fv
}
...
type ProbingDistribution_Status_Regional struct {
	...
	AssignedCount int64 `protobuf:"varint,1,opt,name=assigned_count,json=assignedCount,proto3" json:"assigned_count,omitempty" firestore:"assignedCount"`
	...
	SkippedSessionCount int64 `protobuf:"varint,3,opt,name=skipped_session_count,json=skippedSessionCount,proto3" json:"skipped_session_count,omitempty" firestore:"skippedSessionCount"`
	// Sample list of sessions that were not selected due to limits.
	// If list gets too big its striped to samples only.
	SampleSkippedSessions []string `protobuf:"bytes,4,rep,name=sample_skipped_sessions,json=sampleSkippedSessions,proto3" json:"sample_skipped_sessions,omitempty" firestore:"sampleSkippedSessions"`
}

func (m *ProbingDistribution_Status_Regional) Reset() {
	*m = ProbingDistribution_Status_Regional{}
	if protoimpl.UnsafeEnabled {
		mi := &watchdog_proto_v1alpha2_probing_distribution_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		ms.StoreMessageInfo(mi)
	}
}

func (m *ProbingDistribution_Status_Regional) String() string {
	return protoimpl.X.MessageStringOf(m)
}

func (*ProbingDistribution_Status_Regional) ProtoMessage() {}

func (m *ProbingDistribution_Status_Regional) ProtoReflect() preflect.Message {
	mi := &watchdog_proto_v1alpha2_probing_distribution_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && m != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(m))
		if ms.LoadMessageInfo() == nil {
...
func (*ProbingDistribution_Status_Regional) Descriptor() ([]byte, []int) {
	return watchdog_proto_v1alpha2_probing_distribution_proto_rawDescGZIP(), []int{0, 1, 0}
}

func (m *ProbingDistribution_Status_Regional) Unmarshal(b []byte) error {
	return proto.Unmarshal(b, m)
}

func (m *ProbingDistribution_Status_Regional) Marshal() ([]byte, error) {
	return proto.Marshal(m)
}
...
func (m *ProbingDistribution_Status_Regional) GetSampleSkippedSessions() []string {
	if m != nil {
		return m.SampleSkippedSessions
	}
	return nil
}
...
func (m *ProbingDistribution_Status_Regional) SetAssignedCount(fv int64) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "AssignedCount", "ProbingDistribution_Status_Regional"))
	}
	m.AssignedCount = fv
}
...
func (m *ProbingDistribution_Status_Regional) SetTargetCount(fv int64) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "TargetCount", "ProbingDistribution_Status_Regional"))
	}
	m.TargetCount = fv
}
...
func (m *ProbingDistribution_Status_Regional) SetSkippedSessionCount(fv int64) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "SkippedSessionCount", "ProbingDistribution_Status_Regional"))
	}
	m.SkippedSessionCount = fv
}

func (m *ProbingDistribution_Status_Regional) SetSampleSkippedSessions(fv []string) {
	if m == nil {
		panic(fmt.Errorf("can't set %s on nil %s", "SampleSkippedSessions", "ProbingDistribution_Status_Regional"))
	}
	m.SampleSkippedSessions = fv
}
...
var watchdog_proto_v1alpha2_probing_distribution_proto_rawDesc = []byte{
	...
	0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8f, 0x0e, 0x0a, 0x13, 0x50,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x1a, 0xfc, 0x02,
	...
	,
	...
	,
	...
	,
	...
	0x12, 0x0c, 0x73, 0x70, 0x65, 0x63, 0x2e, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x12, 0x10,
	...
	0x6e, 0x61, 0x6d, 0x65, 0x1a, 0x14, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x63,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0xda, 0x94, 0x23, 0x08, 0x12, 0x06,
	0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0xc2, 0x85, 0x2c, 0x2c, 0x22, 0x04, 0x6e, 0x61, 0x6d, 0x65,
	...
	0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xe2, 0xde, 0x21, 0x02, 0x08, 0x01, 0x42, 0xaa, 0x03, 0xe8,
	0xde, 0x21, 0x01, 0xd2, 0xff, 0xd0, 0x02, 0x5e, 0x0a, 0x1a, 0x70, 0x72, 0x6f, 0x62, 0x69, 0x6e,
	0x67, 0x5f, 0x64, 0x69, 0x73, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x73,
	0x74, 0x6f, 0x72, 0x65, 0x12, 0x40, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
	...
	0x70, 0x68, 0x61, 0x32, 0x42, 0x18, 0x50, 0x72, 0x6f, 0x62, 0x69, 0x6e, 0x67, 0x44, 0x69, 0x73,
	0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01,
	0x5a, 0x59, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x6c, 0x6f,
	...
	0x69, 0x73, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0xd2, 0x84, 0xd1, 0x02, 0x44,
	...
	0x70, 0x68, 0x61, 0x32, 0xa2, 0x80, 0xd1, 0x02, 0x60, 0x0a, 0x1b, 0x70, 0x72, 0x6f, 0x62, 0x69,
...
var watchdog_proto_v1alpha2_probing_distribution_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var watchdog_proto_v1alpha2_probing_distribution_proto_goTypes = []interface{}{
	...
	(*ProbingDistribution_Status_Regional)(nil), // 3: ntt.watchdog.v1alpha2.ProbingDistribution.Status.Regional
	nil,                              // 4: ntt.watchdog.v1alpha2.ProbingDistribution.Status.ByRegionEntry
	(*ntt_meta.Meta)(nil),            // 5: ntt.types.Meta
	(*common.ProbingConstraint)(nil), // 6: ntt.watchdog.v1alpha2.ProbingConstraint
	(*common.ProbingSettings)(nil),   // 7: ntt.watchdog.v1alpha2.ProbingSettings
}
var watchdog_proto_v1alpha2_probing_distribution_proto_depIdxs = []int32{
	5, // 0: ntt.watchdog.v1alpha2.ProbingDistribution.metadata:type_name -> ntt.types.Meta
	...
	6, // 3: ntt.watchdog.v1alpha2.ProbingDistribution.Spec.constraint:type_name -> ntt.watchdog.v1alpha2.ProbingConstraint
	7, // 4: ntt.watchdog.v1alpha2.ProbingDistribution.Spec.probing_settings:type_name -> ntt.watchdog.v1alpha2.ProbingSettings
	4, // 5: ntt.watchdog.v1alpha2.ProbingDistribution.Status.by_region:type_name -> ntt.watchdog.v1alpha2.ProbingDistribution.Status.ByRegionEntry
	3, // 6: ntt.watchdog.v1alpha2.ProbingDistribution.Status.ByRegionEntry.value:type_name -> ntt.watchdog.v1alpha2.ProbingDistribution.Status.Regional
...
func watchdog_proto_v1alpha2_probing_distribution_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		watchdog_proto_v1alpha2_probing_distribution_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProbingDistribution_Status_Regional); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
