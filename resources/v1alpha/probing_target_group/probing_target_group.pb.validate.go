...
func (obj *ProbingTargetGroup) GotenValidate() error {
	...
	if subobj, ok := interface{}(obj.State).(gotenvalidate.Validator); ok {
		if err := subobj.GotenValidate(); err != nil {
			return gotenvalidate.NewValidationError("ProbingTargetGroup", "state", obj.State, "nested object validation failed", err)
		}
	}
	if subobj, ok := interface{}(obj.Metadata).(gotenvalidate.Validator); ok {
		if err := subobj.GotenValidate(); err != nil {
			return gotenvalidate.NewValidationError("ProbingTargetGroup", "metadata", obj.Metadata, "nested object validation failed", err)
		}
	}
